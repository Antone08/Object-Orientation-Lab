...
const whyNotDog = new Cat('Aries', 8, 'black')

console.log(whyNotDog.name)
...
const retribution = new Wizard('Sicario', 30, 'destruction on demand')

retribution.castSpell()
...
let phoneOne = new Phone('Samsung', 'Note9', 256, 'black', 1000)
let phoneTwo = new Phone('Samsung', 'Galaxy S21', 256, 'silver', 1200)
let phoneThree = new Phone('Google', 'Pixel 5a 5G', 128, 'balck', 500)
...
const myFirstVehicle = new Vehicle(6, 'black & white', 62500)
...
const myFirstMotorcycle = new Motorcycle(1, 'black', 1500, 'Honda', false) 
...
const myFirstBoat = new Boat(20, 'red', 2000, 'High Rise', 'yacht', false)
